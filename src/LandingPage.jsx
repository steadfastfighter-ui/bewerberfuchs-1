    ...
    <div className="min-h-screen bg-[#0b0f19] text-white">
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-[#0b0f19]/80 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          ...
          <button
            onClick={goDashboard}
            className="bg-orange-500 hover:bg-orange-400 transition text-black font-bold px-5 py-3 rounded-2xl shrink-0"
          >
            Jetzt starten
          </button>
        </div>
      ...
      <section className="px-6 py-16 md:py-20 max-w-7xl mx-auto flex flex-col 2xl:flex-row gap-14 items-center justify-between">
        <div className="w-full 2xl:max-w-[560px]">
          ...
          <h1 className="text-4xl md:text-5xl font-black leading-[1.08] mb-8 max-w-[560px]">
        ...
        <div className="bg-white/5 border border-white/10 rounded-[36px] p-6 shadow-2xl shadow-black/40 w-full max-w-[620px]">
          <div className="bg-black/40 rounded-[28px] p-6">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={item}
                  className="bg-white/5 border border-white/10 rounded-2xl p-4 flex justify-between gap-4"
                >
                  <span>{item}</span>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-[28px] p-8">
              ...
              <p className="text-gray-200 leading-relaxed">
                ...
                eine zuverlässige, strukturierte Arbeitsweise mit. Besonders
                die Kommissionierung, Warenkontrolle und termingerechte
                Bearbeitung von Aufträgen passen sehr gut zu den Anforderungen
                Ihrer Stelle.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-8">
              ...
              Stellenanzeige. Dadurch werden Anschreiben und Lebenslauf
              gezielter, relevanter und überzeugender.
            </p>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {examples.map((item, index) => (
              ...
              >
                <div className="text-orange-400 text-xl mb-4">{item[0]}</div>
                <p className="text-gray-300 leading-relaxed mb-6">{item[1]}</p>
      ...
      <section id="faq" className="px-6 py-24 bg-black/20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-black">Häufige Fragen</h2>
          </div>
